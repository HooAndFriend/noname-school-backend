...
import com.noname.global.dto.CommonResponse;
import com.noname.global.dto.TokenDto;
import com.noname.global.enums.UserRole;
import com.noname.global.exception.BadRequestException;
import com.noname.global.exception.NotFoundException;
import com.noname.global.jwt.JwtTokenProvider;
import com.noname.global.jwt.JwtTokenValidator;
...
public class UserService {
    ...
    public ResponseEntity<?> loginUser(RequestUserLoginDto dto) {
        ...
        // ** Token 생성
        TokenDto tokenDto = jwtTokenProvider.issueToken(loginUser.getUserId(), UserRole.ROLE_MEMBER);
